							...
							<div class="card-body">
								...
								<div class="data-tables datatable-dark">
									<table id="dataTable3" class="text-center">
										...
										$no = 1;
										if ($data_lokasi == 0) {
										echo "<script>alert('Data data_lokasi Kosong')</script>";
										}
										else {
										...
										<tr>
											...
											<td><?php echo $row->nm_lokasi ?>
											<td><?php echo $row->lat ?></td>
											<td><?php echo $row->long ?></td>
											<td>
												<a href="<?php echo site_url('admin/C_master/edit_data_attribute/'.$row->id_lokasi);?>"
													span class="btn btn-primary"><span class=" glyphicon glyphicon-def">
														Edit</span></a>
												<a href="<?php echo site_url('admin/C_master/hapus_data_attribute/'.$row->id_lokasi);?>"
