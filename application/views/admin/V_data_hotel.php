							...
							<div class="card-body">
								...
								<div class="data-tables datatable-dark">
									<table id="dataTable3" class="text-center">
										...
										$no = 1;
										if ($data_hotel == 0) {
										echo "<script>alert('Data data_hotel Kosong')</script>";
										}
										else {
										...
										<tr>
											...
											<td><?php echo $row->nama_hotel ?>
                                            <td><?php echo $row->id_lokasi ?>
                                            ...
                                            <td><?php echo $row->id_review ?>
                                            <td><?php echo $row->id_kelas ?>
                                            <td><?php echo $row->id_tipe_kamar ?>
											
											<td>
												<a href="<?php echo site_url('admin/C_master/edit_data_attribute/'.$row->id_hotel);?>"
													span class="btn btn-primary"><span class=" glyphicon glyphicon-def">
														Edit</span></a>
												<a href="<?php echo site_url('admin/C_master/hapus_data_attribute/'.$row->id_hotel);?>"
