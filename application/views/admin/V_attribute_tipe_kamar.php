							...
							<div class="card-body">
								...
								<div class="data-tables datatable-dark">
									<table id="dataTable3" class="text-center">
										...
										<?php
										$no = 1;
										if ($data_tipe_kamar == 0) {
										echo "<script>alert('Data data_tipe_kamar Kosong')</script>";
										}
										else {
										...
										<tr>
											...
											<td><?php echo $row->tipe_kamar ?>
											
											<td>
												<a href="<?php echo site_url('admin/C_master/edit_data_attribute/'.$row->id_tipe_kamar);?>"
													span class="btn btn-primary"><span class=" glyphicon glyphicon-def">
														Edit</span></a>
												<a href="<?php echo site_url('admin/C_master/hapus_data_attribute/'.$row->id_tipe_kamar);?>"
