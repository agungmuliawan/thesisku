							...
							<div class="card-body">
								...
								<div class="data-tables datatable-dark">
									<table id="dataTable3" class="text-center">
										...
										$no = 1;
										if ($data_kelas == 0) {
										echo "<script>alert('Data data_kelas Kosong')</script>";
										}
										else {
										...
										<tr>
											...
											<td>
												<a href="<?php echo site_url('admin/C_master/edit_data_attribute/'.$row->id_kelas);?>"
													span class="btn btn-primary"><span class=" glyphicon glyphicon-def">
														Edit</span></a>
												<a href="<?php echo site_url('admin/C_master/hapus_data_attribute/'.$row->id_kelas);?>"
