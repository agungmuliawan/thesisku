			...
			<nav>
				<ul class="metismenu" id="menu">
					...
					?>
						...
						<li class="active">
							<a href="<?php echo site_url('admin/C_home') ?>" aria-expanded="true"><i class="ti-home active"></i><span>Home</span></a>
						</li>
						<li>
					...
					?>
						<li class="active">
							<a href="<?php echo site_url('dosen/C_home') ?>" aria-expanded="true"><i class="ti-home active"></i><span>Home</span></a>
						</li>
						...
						<li><a href="<?php echo site_url('dosen/C_pgm_dsn') ?>"><i class="ti-info"><span>Pengumuman</span></i></a></li>
					<?php
					} else {
					?>
						<li class="active">
							<a href="javascript:void(0)" aria-expanded="true"><i class="ti-home active"></i><span>Home</span></a>
						</li>
						<li class="active">
							<a href="javascript:void(0)" aria-expanded="true"><i class="ti-home active"></i><span>Home</span></a>
						</li>
						...
						<li><a href="<?php echo site_url('mahasiswa/C_pgm_mhs') ?>"><i class="ti-info"><span>Contact</span></i></a></li>
					<?php
					}
					?>
				</ul>
