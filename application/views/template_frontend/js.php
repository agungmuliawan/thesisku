<div id="ftco-loader" class="show fullscreen"><svg class="circular" width="48px" height="48px">
	...
	<script src="<?php echo base_url('frontend/js/jquery-migrate-3.0.1.min.js')?>"></script>
	...
	<script src="<?php echo base_url('frontend/js/jquery.stellar.min.js')?>"></script>
	...
	<script src="<?php echo base_url('frontend/js/aos.js')?>"></script>
	<script src="<?php echo base_url('frontend/js/jquery.animateNumber.min.js')?>"></script>
